...
class GridApp:
    ...
    def __init__(self, 
        ...
        c_width, c_height = canvas_width_px, canvas_height_px
        p_pad = 5
        ...
        self.cells = []
        for iy in range(grid_size_n):
            for ix in range(grid_size_n):
        ...
        def w_click_callback(event):
            ...
            if ix < grid_size_n and iy < grid_size_n and 0 < xc < xsize and 0 < yc < ysize:
                i = iy*grid_size_n+ix
    ...
    def _get_cell_coords(self, i):
        ...
        iy, ix = divmod(i, self.grid_size_n)
        return '{}{}'.format(chr(ix+65), self.grid_size_n-iy)
    ...
    def load_image(self):
        ...
        def _coords_to_index(coords):
            ...
            ix = ord(coords[0])-65
            iy = self.grid_size_n - int(coords[1:])
            return iy*self.grid_size_n + ix
